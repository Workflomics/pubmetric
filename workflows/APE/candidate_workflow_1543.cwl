...
label: WorkflowNo_1542
doc: A workflow including the tool(s) XTandemPipeline, Mascot Server, PChopper, Graph Extract, PAnnBuilder.
...
steps:
  ...
  PAnnBuilder_05:
    ...
    in:
      PAnnBuilder_in_1: PChopper_03/PChopper_out_1
