...
label: WorkflowNo_1671
doc: A workflow including the tool(s) PEAKS De Novo, PeptideProphet, OpenMS, msConvert, MSiReader.
...
steps:
  ...
  MSiReader_05:
    ...
    in:
      MSiReader_in_1: msConvert_04/msConvert_out_1
