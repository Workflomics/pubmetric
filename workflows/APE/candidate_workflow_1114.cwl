...
label: WorkflowNo_1113
doc: A workflow including the tool(s) MassHunter File Reader, MS-Isotope, EncyclopeDIA, OpenMS, OpenSWATH.
...
steps:
  MassHunter File Reader_01:
    ...
    in:
      MassHunter File Reader_in_1: input_3
    out: [MassHunter File Reader_out_1]
  MS-Isotope_02:
    run: add-path-to-the-implementation/MS-Isotope.cwl 
    in:
      MS-Isotope_in_1: MassHunter File Reader_01/MassHunter File Reader_out_1
