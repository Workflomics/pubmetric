...
label: WorkflowNo_165
doc: A workflow including the tool(s) MaxQuant, MSiReader, Graph Extract, OpenSWATH, Mascot Server.
...
inputs:
  ...
  input_2:
    type: File
    format: "http://edamontology.org/format_1551" # Pcons report format
  input_3:
    type: File
