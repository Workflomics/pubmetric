...
label: WorkflowNo_1346
doc: A workflow including the tool(s) msConvert, PeptideProphet, msConvert, Comet, ProteinProphet, StPeter.
...
steps:
  ...
  Comet_04:
    ...
    in:
      Comet_in_1: msConvert_03/msConvert_out_1
      Comet_in_2: input_1
