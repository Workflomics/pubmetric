...
label: WorkflowNo_1100
doc: A workflow including the tool(s) HX-Express, CCdigest, EncyclopeDIA, OpenMS, OpenSWATH.
...
steps:
  ...
  CCdigest_02:
    ...
    in:
      CCdigest_in_1: HX-Express_01/HX-Express_out_1
    out: [CCdigest_out_1]
  EncyclopeDIA_03:
