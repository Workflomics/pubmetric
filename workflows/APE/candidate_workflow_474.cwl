...
label: WorkflowNo_473
doc: A workflow including the tool(s) MassChroQ, MSiReader, MS-Fit, OpenMS, OpenSWATH.
...
steps:
  MassChroQ_01:
    ...
    in:
      MassChroQ_in_1: input_2
    out: [MassChroQ_out_1]
  MSiReader_02:
    run: add-path-to-the-implementation/MSiReader.cwl 
    in:
      MSiReader_in_1: input_3
      MSiReader_in_2: MassChroQ_01/MassChroQ_out_1
