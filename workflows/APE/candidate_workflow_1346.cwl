...
label: WorkflowNo_1345
doc: A workflow including the tool(s) msConvert, PeptideProphet, msConvert, XTandem, ProteinProphet, StPeter.
...
steps:
  ...
  XTandem_04:
    ...
    in:
      XTandem_in_1: msConvert_03/msConvert_out_1
