...
label: WorkflowNo_572
doc: A workflow including the tool(s) ICPL_ESIQuant, CCdigest, MS-Fit, OpenMS, OpenSWATH.
...
steps:
  ...
  CCdigest_02:
    ...
    in:
      CCdigest_in_1: ICPL_ESIQuant_01/ICPL_ESIQuant_out_1
    out: [CCdigest_out_1]
  MS-Fit_03:
