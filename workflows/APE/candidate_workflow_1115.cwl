...
label: WorkflowNo_1114
doc: A workflow including the tool(s) MassHunter File Reader, CCdigest, EncyclopeDIA, OpenMS, OpenSWATH.
...
steps:
  ...
  CCdigest_02:
    ...
    in:
      CCdigest_in_1: MassHunter File Reader_01/MassHunter File Reader_out_1
    out: [CCdigest_out_1]
  EncyclopeDIA_03:
