...
label: WorkflowNo_647
doc: A workflow including the tool(s) CCdigest, OpenSWATH, Mascot Server, MassChroQ, OpenSWATH.
...
steps:
  ...
  Mascot Server_03:
    ...
    in:
      ...
      Mascot Server_in_2: CCdigest_01/CCdigest_out_1
