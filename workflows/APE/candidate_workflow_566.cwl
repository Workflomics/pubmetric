...
label: WorkflowNo_565
doc: A workflow including the tool(s) PEAKS De Novo, CCdigest, MS-Fit, OpenMS, OpenSWATH.
...
steps:
  ...
  CCdigest_02:
    ...
    in:
      CCdigest_in_1: PEAKS De Novo_01/PEAKS De Novo_out_1
    out: [CCdigest_out_1]
  MS-Fit_03:
