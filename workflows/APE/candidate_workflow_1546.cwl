...
label: WorkflowNo_1545
doc: A workflow including the tool(s) XTandemPipeline, OpenMS, mspire-simulator, MSiReader, OBI-Warp.
...
steps:
  ...
  MSiReader_04:
    ...
    in:
      MSiReader_in_1: mspire-simulator_03/mspire-simulator_out_1
      MSiReader_in_2: OpenMS_02/OpenMS_out_2
    out: [MSiReader_out_1, MSiReader_out_2]
  OBI-Warp_05:
    run: add-path-to-the-implementation/OBI-Warp.cwl 
    in:
      OBI-Warp_in_1: MSiReader_04/MSiReader_out_2
    out: [OBI-Warp_out_1]
outputs:
  output_1:
    type: File
    format: "http://edamontology.org/format_3911" # msh
    outputSource: OBI-Warp_05/OBI-Warp_out_1
