...
label: WorkflowNo_721
doc: A workflow including the tool(s) PEAKS DB, OpenMS, PeptideShaker, MSiReader, MSiReader.
...
steps:
  ...
  MSiReader_04:
    ...
    in:
      ...
      MSiReader_in_2: PeptideShaker_03/PeptideShaker_out_3
