...
label: WorkflowNo_1677
doc: A workflow including the tool(s) PChopper, PeptideProphet, OpenMS, COMSPARI, MSiReader.
...
steps:
  ...
  COMSPARI_04:
    run: add-path-to-the-implementation/COMSPARI.cwl 
    in:
      COMSPARI_in_1: input_2
    out: [COMSPARI_out_1]
  MSiReader_05:
    run: add-path-to-the-implementation/MSiReader.cwl 
    in:
      MSiReader_in_1: COMSPARI_04/COMSPARI_out_1
