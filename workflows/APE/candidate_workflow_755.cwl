...
label: WorkflowNo_754
doc: A workflow including the tool(s) Scop3d, mzStar, MS-Fit, OpenMS, OpenSWATH.
...
steps:
  Scop3d_01:
    run: add-path-to-the-implementation/Scop3d.cwl 
    in:
      Scop3d_in_1: input_2
    out: [Scop3d_out_1]
  mzStar_02:
    ...
    in:
      mzStar_in_1: Scop3d_01/Scop3d_out_1
    out: [mzStar_out_1]
  MS-Fit_03:
