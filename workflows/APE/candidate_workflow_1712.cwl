...
label: WorkflowNo_1711
doc: A workflow including the tool(s) XTandemPipeline, Mascot Server, dig, Graph Extract, LimmaRP.
...
steps:
  ...
  LimmaRP_05:
    ...
    in:
      LimmaRP_in_1: dig_03/dig_out_1
      LimmaRP_in_2: Graph Extract_04/Graph Extract_out_1
    out: [LimmaRP_out_1]
outputs:
  output_1:
    type: File
