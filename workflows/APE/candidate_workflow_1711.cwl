...
label: WorkflowNo_1710
doc: A workflow including the tool(s) XTandemPipeline, Mascot Server, PChopper, Graph Extract, LimmaRP.
...
steps:
  ...
  LimmaRP_05:
    ...
    in:
      LimmaRP_in_1: PChopper_03/PChopper_out_1
