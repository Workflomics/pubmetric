...
label: WorkflowNo_740
doc: A workflow including the tool(s) MassHunter File Reader, msmsEDA, MSiReader, ComPIL, PEAKS Q.
...
steps:
  ...
  MSiReader_03:
    ...
    in:
      MSiReader_in_1: MassHunter File Reader_01/MassHunter File Reader_out_1
