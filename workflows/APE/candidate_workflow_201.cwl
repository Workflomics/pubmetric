...
label: WorkflowNo_200
doc: A workflow including the tool(s) CrosstalkDB, PRIDE Toolsuite, MS-Fit, OpenMS, PeptideShaker.
...
steps:
  ...
  MS-Fit_03:
    ...
    in:
      MS-Fit_in_1: PRIDE Toolsuite_02/PRIDE Toolsuite_out_1
    out: [MS-Fit_out_1]
  OpenMS_04:
    run: add-path-to-the-implementation/OpenMS.cwl 
    in:
      OpenMS_in_1: PRIDE Toolsuite_02/PRIDE Toolsuite_out_1
      OpenMS_in_2: input_3
