...
label: WorkflowNo_537
doc: A workflow including the tool(s) hydrogen_bondifier, MS-Isotope, MS-Fit, OpenMS, OpenSWATH.
...
steps:
  ...
  MS-Isotope_02:
    ...
    in:
      MS-Isotope_in_1: hydrogen_bondifier_01/hydrogen_bondifier_out_1
