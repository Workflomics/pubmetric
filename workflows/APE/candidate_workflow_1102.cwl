...
label: WorkflowNo_1101
doc: A workflow including the tool(s) PEAKS De Novo, MS-Isotope, EncyclopeDIA, OpenMS, OpenSWATH.
...
steps:
  ...
  MS-Isotope_02:
    ...
    in:
      MS-Isotope_in_1: PEAKS De Novo_01/PEAKS De Novo_out_1
