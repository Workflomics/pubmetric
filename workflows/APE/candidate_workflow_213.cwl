...
label: WorkflowNo_212
doc: A workflow including the tool(s) MassWiz, PEAKS Q, CrosstalkDB, InDigestion, DIA-Umpire.
...
inputs:
  ...
  input_2:
    type: File
    format: "http://edamontology.org/format_1986" # markx1
  input_3:
    type: File
...
steps:
  ...
  DIA-Umpire_05:
    ...
    in:
      ...
      DIA-Umpire_in_2: CrosstalkDB_03/CrosstalkDB_out_3
