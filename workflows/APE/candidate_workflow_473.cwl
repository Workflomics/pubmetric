...
label: WorkflowNo_472
doc: A workflow including the tool(s) MSImageView, MSiReader, MS-Fit, OpenMS, OpenSWATH.
...
steps:
  MSImageView_01:
    run: add-path-to-the-implementation/MSImageView.cwl 
    in:
      MSImageView_in_1: input_1
    out: [MSImageView_out_1]
  MSiReader_02:
    run: add-path-to-the-implementation/MSiReader.cwl 
    in:
      MSiReader_in_1: input_3
      MSiReader_in_2: MSImageView_01/MSImageView_out_1
