...
label: WorkflowNo_1274
doc: A workflow including the tool(s) PChopper, EncyclopeDIA, OpenMS, RelEx, PPIExp.
...
outputs:
  output_1:
    type: File
    format: "http://edamontology.org/format_3772" # BioJSON (BioXSD)
