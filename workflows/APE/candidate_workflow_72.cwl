...
label: WorkflowNo_71
doc: A workflow including the tool(s) InDigestion, libmgf, MR-MSPOLYGRAPH, Percolator, Quant.
...
inputs:
  ...
  input_2:
    type: File
    format: "http://edamontology.org/format_1969" # debug-seq
  input_3:
    type: File
...
steps:
  ...
  MR-MSPOLYGRAPH_03:
    ...
    in:
      MR-MSPOLYGRAPH_in_1: libmgf_02/libmgf_out_1
