...
label: WorkflowNo_475
doc: A workflow including the tool(s) Jtraml, DECIPHER, MS-Fit, OpenMS, OpenSWATH.
...
steps:
  ...
  DECIPHER_02:
    ...
    in:
      DECIPHER_in_1: Jtraml_01/Jtraml_out_1
      DECIPHER_in_2: input_2
  ...
  OpenMS_04:
    ...
    in:
      OpenMS_in_1: input_1
      OpenMS_in_2: DECIPHER_02/DECIPHER_out_1
