...
label: WorkflowNo_524
doc: A workflow including the tool(s) isoScale, MS-Isotope, MS-Fit, OpenMS, OpenSWATH.
...
steps:
  isoScale_01:
    run: add-path-to-the-implementation/isoScale.cwl 
    in:
      isoScale_in_1: input_2
    out: [isoScale_out_1]
  MS-Isotope_02:
    run: add-path-to-the-implementation/MS-Isotope.cwl 
    in:
      MS-Isotope_in_1: isoScale_01/isoScale_out_1
