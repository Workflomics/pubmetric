...
label: WorkflowNo_1607
doc: A workflow including the tool(s) OpenChrom, msmsEDA, Graph Extract, PECAN (PEptide-Centric Analysis), Mascot Server.
...
steps:
  ...
  Graph Extract_03:
    ...
    in:
      Graph Extract_in_1: msmsEDA_02/msmsEDA_out_2
