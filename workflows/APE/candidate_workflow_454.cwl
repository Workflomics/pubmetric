...
label: WorkflowNo_453
doc: A workflow including the tool(s) Isotope calculator, MSiReader, MS-Fit, OpenMS, OpenSWATH.
...
steps:
  Isotope calculator_01:
    run: add-path-to-the-implementation/Isotope calculator.cwl 
    in:
      Isotope calculator_in_1: input_2
    out: [Isotope calculator_out_1]
  MSiReader_02:
    run: add-path-to-the-implementation/MSiReader.cwl 
    in:
      MSiReader_in_1: input_3
      MSiReader_in_2: Isotope calculator_01/Isotope calculator_out_1
