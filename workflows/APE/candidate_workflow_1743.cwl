...
label: WorkflowNo_1742
doc: A workflow including the tool(s) PeptideProphet, ProteinProphet, idconvert, mzRecal, Comet, mzRecal, StPeter.
...
steps:
  ...
  mzRecal_06:
    ...
    in:
      mzRecal_in_1: input_2
      mzRecal_in_2: Comet_05/Comet_out_2
    out: [mzRecal_out_1]
  StPeter_07:
