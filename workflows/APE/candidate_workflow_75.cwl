...
label: WorkflowNo_74
doc: A workflow including the tool(s) msmsEDA, esimsa2D, MSiReader, OpenSWATH, Mascot Server.
...
inputs:
  ...
  input_3:
    type: File
    format: "http://edamontology.org/format_3836" # BLAST XML v2 results format
steps:
  msmsEDA_01:
