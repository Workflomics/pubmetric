...
label: WorkflowNo_541
doc: A workflow including the tool(s) hydrogen_bondifier, PChopper, MS-Fit, OpenMS, OpenSWATH.
...
steps:
  ...
  PChopper_02:
    ...
    in:
      PChopper_in_1: hydrogen_bondifier_01/hydrogen_bondifier_out_1
    out: [PChopper_out_1]
  MS-Fit_03:
