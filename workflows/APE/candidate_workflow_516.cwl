...
label: WorkflowNo_515
doc: A workflow including the tool(s) UniMod, MS-Isotope, MS-Fit, OpenMS, OpenSWATH.
...
steps:
  UniMod_01:
    run: add-path-to-the-implementation/UniMod.cwl 
    in:
      UniMod_in_1: input_2
    out: [UniMod_out_1]
  MS-Isotope_02:
    ...
    in:
      MS-Isotope_in_1: UniMod_01/UniMod_out_1
